...
public:
	...
	Primitive* Raytrace( Ray& a_Ray, Color& a_Acc, int a_Depth, float a_RIndex, float& a_Dist, Color& dirLC,bool flag, Color& Specular, Color& B_withoutOBJ, Color& realB,bool bG);
	Primitive* bGraytrace(Ray& a_Ray,Color& realB,int a_Depth,float a_RIndex,float& a_Dist,bool flag);
	void InitRender();
	bool Render();
protected:
	// renderer data
